    ...
    def generate_intervention_summary(self, needs_summary: str, future_action: Dict[str, Any]) -> Optional[str]:
        ...
        try:
            ...
            intervention_summary_prompt = (
                ...
                "- Be extra careful handling any facts or numbers with precision\n"
...
class RRCapacityTask(BaseAITask):
    ...
    def _build_system_prompt(self, critical_question: str, area: str, top_facts: str) -> str:
        ...
        base_prompt = (
            ...
            f"'There are not enough sources available to answer this question.'\n\n"
            ...
            f"- If insufficient source data, respond: 'There are not enough sources available to answer this question.'\n"
