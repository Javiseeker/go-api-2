...
class PerDrefLLMSummaryView(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            print(f"\n💥 EXCEPTION in PerDrefLLMSummaryView:")
    ...
    def _generate_ai_summary(self, structured_data: List[Dict]) -> List[Dict]:
        ...
        system_message = {
            ...
            "content": (
                ...
                "**Do not** create your own identifiers. **Do not** omit any field. **Do not** wrap your JSON in markdown. **Do not** add anything to the source besides the event id and event name (eg: \"1234\":\"Bangladesh: Cyclone Response)."
                "**Do not** change the strucutre of the source it should only look like:  \"5491\": \"NIGER: INONDATION 2021-08-09\" "
                "Example:\n"
                "[\n"
